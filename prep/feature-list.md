...
2. **Ratings:** 🌶 hype (1–5 chillies) and 🚩 red flags (1–5 flags for gaps in the evidence), both "fewer is better", plus a one-sentence explanation.
...
6. **Red flags breakdown** in "Why this rating?" (three parts).
...
12. **Colour-coded markup view** (about 4 hours), shown **alongside** the score breakdown and Behind the Claim. The article is shown with highlights, each with a colour **plus an icon and label** (not colour alone). Clicking one explains the finding and, where relevant, shows the matching source passage. Categories:
    ...
    - **🚩 Evidence & sourcing family (crimson), adds red flags:**
    ...
    - **✓ Good practice (green), reduces red flags:** independent expert, links the study, states limits
...
> 4. Red flags breakdown panel dropped, since the markup view shows the same findings
>
...
13. **Sorts:** Newest (default), Fewest red flags, Most hyped, Unrated.
