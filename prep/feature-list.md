...
- **Rating display: under review.** Leyla keeps the chilli hype meter; the two-scale layout confused. Options D (chilli meter + evidence in words) and E (verdict line + chilli meter) are on the mockup canvas.
