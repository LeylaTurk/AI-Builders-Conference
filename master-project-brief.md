...
| Mockup | **First version done** 26 September: four clickable screens, recoloured to the chosen "Night edition" palette; rating display still being chosen (see `mockup/`). |
